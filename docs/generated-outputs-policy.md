...
- In the LOD pipeline, xLODGen/SSELODGen is used for **terrain LOD only** (basic pass: Tamriel). Object/tree LOD is generated by DynDOLOD. See `docs/manual-lod-generation.md`.
